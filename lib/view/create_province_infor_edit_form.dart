...
class CreateProvinceInforEditForm extends StatefulWidget {
  const CreateProvinceInforEditForm(
      {super.key,
      required this.title,
  ...
  @override
  State<CreateProvinceInforEditForm> createState() =>
      _CreateProvinceInforEditForm();
}
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            ...
            children: [
              ...
              InputForm(
                  keyboardType: title == 'License plate'
